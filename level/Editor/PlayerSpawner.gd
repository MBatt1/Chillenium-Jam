...
func spawn(level, cam):
	...
	if player_id == 0:
		copy.setup(weight, friction, drag, speed, jump_strength, color, cam, "p1_up", "p1_right", "p1_down", "p1_left", "p1_use")
	elif player_id == 1:
		copy.setup(weight, friction, drag, speed, jump_strength, color, cam, "p2_up", "p2_right", "p2_down", "p2_left", "p2_use")
	else:
